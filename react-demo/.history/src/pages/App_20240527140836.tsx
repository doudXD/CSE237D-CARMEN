        ...
        <div
          ...
          <div>
            <div style={{ marginTop: "20px", height: "400px", overflowY: "auto" }}>
              ...
              {messageHistory && 
                Object.entries(messageHistory[2]).map((message, index) => {
                  console.log("message: " + JSON.stringify(messageHistory[2][0][1]));

                  const hasPrompt = (JSON.parse(message)).hasOwnProperty("Prompt");
